...
class AttemptsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attempt" do
    assert_difference('Attempt.count') do
      post attempts_url, params: { attempt: { answer_id: @attempt.answer_id, attempts: @attempt.attempts, candidate_id: @attempt.candidate_id, question_id: @attempt.question_id } }
    end
  ...
  test "should update attempt" do
    patch attempt_url(@attempt), params: { attempt: { answer_id: @attempt.answer_id, attempts: @attempt.attempts, candidate_id: @attempt.candidate_id, question_id: @attempt.question_id } }
